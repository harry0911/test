...
while True:
    while True:
        # 모델 위치
        model_filename='/home/pi/Desktop/keras_here.h5'
        ...
        if start==1:
            ...
            checktime="%s년 %s월 %s일 %s시 %s분" %(now.year, now.month, now.day, now.hour, now.minute)
            print(checktime)
            import datetime
            import time
            nothing=0
                ...
                if p!=0:
                    ...
                    if (prediction[0,0] < prediction[0,1]):
                        ...
                        if tmp>=33:
                            ...
                            noth+=1
                        if noth==2:
                            tk_image1 = PhotoImage(file='/home/pi/Desktop/no_weather.png')
